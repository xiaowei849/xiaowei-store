                            ...
                            <ul class="sui-nav">
                                <li :class="{ active: isOne }" @click="changeOrder('1')">
                                    <a>综合<span v-show="isOne" class="iconfont"
                                            :class="{'icon-jiantou_xiangshang':isAsc, 'icon-jiantou_xiangxia': !isAsc}"></span></a>
                                </li>
                                <li :class="{ active: !isOne }" @click="changeOrder('2')">
                                    <a>价格<span v-show="!isOne" class="iconfont"
                                            :class="{'icon-jiantou_xiangshang':isAsc, 'icon-jiantou_xiangxia': !isAsc}"></span></a>
                                </li>
                            </ul>
                        </div>
        ...
        changeOrder(flag) {
            ...
            if (flag == "1") {
                this.searchParams.order =
                    originOrder == "1:desc" ? "1:asc" : "1:desc";
            } else {
                this.searchParams.order =
                    originOrder == "2:desc" ? "2:asc" : "2:desc";
            }
            this.getData();
        },
        // 自定义函数，获取商品第几页

  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至：<span>{{ defaultInfo.fullAddress }}&nbsp;&nbsp;</span>
        收货人：<span>{{ defaultInfo.consignee }}&nbsp;&nbsp;</span> 电话：<span
          >{{ defaultInfo.phoneNum }}</span
        >
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      // 其余参数
      let data = {
        consignee: this.defaultInfo.consignee, // 收件人
        consigneeTel: this.defaultInfo.phoneNum, // 手机号
        deliveryAddress: this.defaultInfo.fullAddress, // 地址
